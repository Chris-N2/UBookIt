...
Defines the bookable resource domain model for uBookIt: resource identity, extensible resource type keys, single-occupancy semantics, domain purity of `UBookIt.Core`, and the split between booking behaviour and presentation concerns.
