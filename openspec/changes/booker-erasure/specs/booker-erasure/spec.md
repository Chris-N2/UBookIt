...
- **It erases one booking.** A person who booked more than once has one booking erased per
  operation; erasing everything they booked means erasing each. The package does not claim to
  find them all.
...
- **THEN** it states that erasure applies to one booking and that a person's other bookings are unaffected
