...
or is zero or negative, uBookIt logs an **error** at startup and erases nothing. It will never
guess a period on your behalf: keeping data longer than you meant is something you can correct,
and erasing it sooner than you meant is not. If you want the shortest possible period, set `1`
— `0` is treated as a mistake, because it is far more often somebody writing "off".
