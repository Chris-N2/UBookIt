...
- **A version number cannot be reused**, even after unlisting. uBookIt is at `18.1.2`, and
...
```
https://raw.githubusercontent.com/Chris-N2/UBookIt/18.1.2/docs/images/booking-flow.png
```
...
```bash
git tag 18.1.2                  # on the commit you are packing from
git push origin 18.1.2
curl -sI https://raw.githubusercontent.com/Chris-N2/UBookIt/18.1.2/docs/images/booking-flow.png
```
