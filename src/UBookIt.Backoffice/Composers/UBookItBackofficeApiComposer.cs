    ...
    public class UBookItBackofficeApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "UBook It Backoffice Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UBookItBackofficeOperationSecurityFilter>();
            });
        }

        public class UBookItBackofficeOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("UBookIt.Backoffice.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
