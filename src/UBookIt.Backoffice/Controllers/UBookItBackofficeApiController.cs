...
namespace UBookIt.Backoffice.Controllers
{
    ...
    public class UBookItBackofficeApiController : UBookItBackofficeApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public UBookItBackofficeApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
