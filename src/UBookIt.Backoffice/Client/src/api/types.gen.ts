...
export type BookerModel = {
    condition: string;
    contact?: null | BookerContactModel;
    erasedUtc?: null | string;
};
...
export type BookingModel = {
    ...
    service?: null | BookedServiceModel;
};
...
export type ResourceRequestModel = {
    ...
    constraints?: null | ConstraintsModel;
};
...
export type ServiceDurationModel = {
    kind: string;
    minutes?: null | number;
    minMinutes?: null | number;
    maxMinutes?: null | number;
};

export type ServicePreviewRequestModel = {
    roles: Array<ServicePreviewRoleModel>;
    duration?: null | ServiceDurationModel;
};

export type ServicePreviewResponseModel = {
    roles: Array<ServiceRoleChainModel>;
    startMisalignment?: null | StartMisalignmentModel;
    poolShortfall?: null | PoolShortfallModel;
};
