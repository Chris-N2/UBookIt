...
/// </para>
/// <para>
/// It logs and nothing more. The package sends no email and neither does the dev site: what a
/// real site would put here is its own mail, and that is exactly the point of the seam.
/// </para>
/// <para>
