...
Nothing that used to be refused is accepted now. The refusals are what they were: `//host`, a
backslash, a control character, and every scheme except `http` and `https`, which is what keeps
`javascript:` out.
